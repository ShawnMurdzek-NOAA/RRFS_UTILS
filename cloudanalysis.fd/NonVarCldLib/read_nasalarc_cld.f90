...
!                .      .    .                                       .
! subprogram:  read_NASALaRC_fv3   read in nasalarc cloud for fv3
!
!   PRGMMR: Ming Hu          ORG: GSL/AVID        DATE: 2020-08-13
!
! ABSTRACT: 
...
!
  ...
  enddo
     ...
     do k=1,5
        do jj=1,nlat
           do ii=1,nlon
              if(nasalarc(ii,jj,k) > 8888.0_r_single  .or. nasalarc(ii,jj,k) < -0.001) then
...
END SUBROUTINE read_NASALaRC_fv3
