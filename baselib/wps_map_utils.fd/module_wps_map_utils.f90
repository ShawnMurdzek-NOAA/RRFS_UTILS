...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   use module_wps_constants
   use module_wps_misc_definitions
! Remove module_debug for easier compiling
! Also commented out all lines that rely on module_debug
!   use module_debug
...
END MODULE module_wps_map_utils
