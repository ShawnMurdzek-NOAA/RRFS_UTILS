...
!
  ...
  use module_cld_parm_array, only: metar_impact_radius
  use module_cld_parm_array, only: l_metar_impact_radius_change, &
                                   metar_impact_radius_max,metar_impact_radius_min,&
                                   metar_impact_radius_max_height,metar_impact_radius_min_height
  use module_cld_parm_array, only: init_cld_parm

  use module_cld_parm_array, only: obstype, sis, nchanl,nreal,ilat,ilon,ndata
  use module_cld_parm_array, only: cdata_regular
  use module_read_prepbufr_metar, only: read_prepbufr_metarcld 
