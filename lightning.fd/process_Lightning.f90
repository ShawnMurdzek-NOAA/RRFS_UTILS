...
!
  ...
  use module_map_proj_helper, only: init_proj,write_corners
  use module_lightning_bufr_io, only: read_lightning_bufr,write_bufr_lightning
  use module_check_lght_qc, only: Check_Lightning_QC,Check_NLDN
  use module_netCDFsub_lightning, only: get_dim_att_nldn,ifexist_file,get_lightning_nldn
